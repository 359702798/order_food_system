layui.use(['table','form','jquery','layer'], function () {
    ...
    var tableIns =table.render({
        ...
        height: 600,
        url: '../User/getAll' //向后台发送请求获取对应的数据
        ,   //   w为什么要写这样的请求？
        title: '用户管理',
        page: true //开启分页
        ,
        ...
        cols: [
            [ //为什么要展示下面的这些数据？   list<video>-->转换成了json
                ...
                field: 'userId', //必须和返回的json格式数据的key值一摸一样
                title: '餐馆ID',
                sort: true, //排序
                fixed: 'left'
            }, {
                ...
                success:function (res) {
                    layer.open({
                        ...
                        success: function(layero, index){
                            ...
                            body.find('#userPassword').val(res.userPassword)
                            body.find('#userTelephone').val(res.userTelephone)
